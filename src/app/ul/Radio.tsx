...
const Radio = () => {
  ...
  return (
    <Fragment>
            ...
            <div className='flex flex-col w-full lg:ml-0'>
              <form className='' onSubmit={handleSubmit}>
                ...
                <div className='flex w-full lg:w-11/12 justify-between mt-8'>
                  ...
                  <button type='submit' className='w-full bg-purple-900 border-2 border-purple-900 p-3 rounded-md text-white' onClick = {() => setShowModal(true)}>Submit</button>
                </div>
              </form>  
            </div>
          </div>
      ...
      <Proceed isVisible ={showModal} onClose = {()=> setShowModal(false)} />
    </Fragment>
  )
}
